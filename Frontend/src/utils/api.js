...
export const api = {
  ...
  auth: {
    login: async (credentials) => {
      try {
        const response = await apiClient.postOnce('/api/auth/login', credentials);
    ...
    register: async (userData) => {
      try {
        const response = await apiClient.postOnce('/api/auth/register', userData);
    ...
    logout: async () => {
      try {
        await apiClient.postOnce('/api/auth/logout');
      } catch (error) {
    ...
    changePassword: async (passwordData) => {
      try {
        const response = await apiClient.putOnce('/api/auth/change-password', passwordData);
        return response.data;
      } catch (error) {
  ...
  trello: {
    validateCredentials: async () => {
      try {
        const response = await apiClient.get('/api/trello/validate');
        return response.data;
      } catch (error) {
    ...
    getBoards: async (organizationId) => {
      try {
        const url = organizationId ? `/api/trello/boards?organizationId=${organizationId}` : '/api/trello/boards';
    ...
    getBoardDetails: async (boardId) => {
      try {
        const response = await apiClient.get(`/api/trello/boards/${boardId}`);
        return response.data;
      } catch (error) {
    ...
    syncCards: async (boardIds = []) => {
      try {
        const response = await apiClient.post('/api/trello/sync', { boardIds });
        return response.data;
      } catch (error) {
    ...
    getCards: async (filters = {}) => {
      try {
        ...
        const url = `/api/trello/cards${queryParams ? '?' + queryParams : ''}`;
        const response = await apiClient.get(url);
        return response.data;
      } catch (error) {
    ...
    sendReminder: async (cardId, reminderData) => {
      try {
        const response = await apiClient.postOnce(`/api/trello/cards/${cardId}/reminder`, reminderData);
        return response.data;
      } catch (error) {
    ...
    pauseReminders: async (cardId, pauseData) => {
      try {
        const response = await apiClient.putOnce(`/api/trello/cards/${cardId}/pause`, pauseData);
        return response.data;
      } catch (error) {
    ...
    getStats: async () => {
      try {
        const response = await apiClient.get('/api/trello/stats');
        return response.data;
      } catch (error) {
    ...
    triggerMonitoring: async () => {
      try {
        const response = await apiClient.postOnce('/api/trello/monitoring/trigger');
        return response.data;
      } catch (error) {
    ...
    postComment: async (cardId, commentData) => {
      try {
        const response = await apiClient.postOnce(`/api/trello/cards/${cardId}/comments`, commentData);
        return response.data;
      } catch (error) {
    ...
    getMonitoringStatus: async () => {
      try {
        const response = await apiClient.get('/api/trello/monitoring/status');
        return response.data;
      } catch (error) {
  ...
  config: {
    ...
    update: async (configData) => {
      try {
        const response = await apiClient.putOnce('/api/config', configData);
        return response.data;
      } catch (error) {
  ...
  templates: {
    ...
    create: async (templateData) => {
      try {
        const response = await apiClient.postOnce('/api/templates', templateData);
        return response.data;
      } catch (error) {
    ...
    update: async (templateId, templateData) => {
      try {
        const response = await apiClient.putOnce(`/api/templates/${templateId}`, templateData);
        return response.data;
      } catch (error) {
    ...
    delete: async (templateId) => {
      try {
        const response = await apiClient.deleteOnce(`/api/templates/${templateId}`);
        return response.data;
      } catch (error) {
  ...
  reports: {
    getAll: async (filters = {}) => {
      try {
        const queryParams = new URLSearchParams(filters).toString();
        const url = `/api/reports${queryParams ? '?' + queryParams : ''}`;
        const response = await apiClient.get(url);
        return response.data;
      } catch (error) {
    ...
    generate: async (reportData) => {
      try {
        const response = await apiClient.postOnce('/api/reports', reportData);
        return response.data;
      } catch (error) {
  ...
  logs: {
    getAll: async (filters = {}) => {
      try {
        const queryParams = new URLSearchParams(filters).toString();
        const url = `/api/logs${queryParams ? '?' + queryParams : ''}`;
        const response = await apiClient.get(url);
        return response.data;
      } catch (error) {
    ...
    getStats: async (filters = {}) => {
      try {
        const queryParams = new URLSearchParams(filters).toString();
        const url = `/api/logs/stats${queryParams ? '?' + queryParams : ''}`;
        const response = await apiClient.get(url);
        return response.data;
      } catch (error) {
  ...
  notifications: {
    test: async (channel, testData) => {
      try {
        const response = await apiClient.postOnce('/api/notifications/test', { channel, ...testData });
        return response.data;
      } catch (error) {
    ...
    getStats: async (startDate, endDate) => {
      try {
        ...
        const response = await apiClient.get(`/api/notifications/stats?${params}`);
        return response.data;
      } catch (error) {
    ...
    sendNotification: async (notificationData) => {
      try {
        const response = await apiClient.postOnce('/api/notifications/send', notificationData);
        return response.data;
      } catch (error) {
