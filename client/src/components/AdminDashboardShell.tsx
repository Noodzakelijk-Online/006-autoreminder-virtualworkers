...
export default function AdminDashboardShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    ...
    >
      <AdminDashboardShellContent setSidebarWidth={setSidebarWidth}>
        {children}
...
type AdminDashboardShellContentProps = {
...
function AdminDashboardShellContent({
  children,
  setSidebarWidth,
}: AdminDashboardShellContentProps) {
  ...
  const menuItems = user?.role === "worker"
    ...
    : [
        ...
        { icon: ShieldAlert, label: "Robert Dashboard", path: "/robert" },
        { icon: Zap, label: "Command Center", path: "/command-center" },
        { icon: Shield, label: "Admin Monitor", path: "/admin" },
