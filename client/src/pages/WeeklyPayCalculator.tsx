      ...
      <Card className="overflow-hidden border border-border shadow-sm">
        <div className="bg-card p-5 text-foreground">
          ...
          <div className="rounded-md border border-border bg-muted/30 p-4">
            <p className="mb-1 text-center text-[10px] uppercase text-muted-foreground">Projected Pay This Week</p>
            <p className={`text-center font-mono text-3xl font-bold ${projectedPay < 0 ? "text-destructive" : "text-foreground"}`}>
            ...
            <div className="flex justify-center gap-4 mt-2 text-xs">
              ...
              <span className="text-destructive">- ${totalDemerits.toFixed(2)} demerits</span>
              <span className="text-primary">+ ${totalMerits.toFixed(2)} merits</span>
            </div>
            {projectedPay < 0 && (
