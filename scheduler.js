...
class SchedulerService {
  ...
  initializeDay0CommentJob(config) {
    this.jobs.day0Comment = new cron.CronJob(
  ...
  initializeDay1EmailJob(config) {
    this.jobs.day1Email = new cron.CronJob(
  ...
  initializeDay2SmsJob(config) {
    this.jobs.day2Sms = new cron.CronJob(
      CRON_TIMES.SMS_TIME,
      async () => {
        try {
          // Skip if weekend and no override
  ...
  initializeDailyReportJob() {
    this.jobs.dailyReport = new cron.CronJob(
  ...
  initializeWeeklyReportJob() {
    this.jobs.weeklyReport = new cron.CronJob(
